...
const Header = ({ isOpaque = false, onRegister }: HeaderProps) => {
  ...
  return (
    <header
      className={`fixed left-0 top-0 z-[210] w-full transition-all duration-300 font-display uppercase tracking-tight hidden md:block ${scrolled || isOpaque ? "bg-black/80 backdrop-blur-md" : "bg-gradient-to-b from-black via-black/40 to-transparent"
        }`}
    >
