...
const events = [
    {
        ...
        image: { url: "/stock-videos/Dance.mp4", type: "video" },
        rules: [
            "Team size: 3–12 participants.",
            "Time limit: 3–5 minutes.",
            "Props allowed for performance.",
    ...
    },
    {
        ...
        image: { url: "/stock-videos/Solo-Dance.mp4", type: "video" },
        rules: [
    ...
    },
    {
        ...
        image: { url: "/stock-videos/Group-Singing.mp4", type: "video" },
        rules: [
    ...
    },
    {
        ...
        image: { url: "/stock-videos/Singing.mp4", type: "video" },
        rules: [
            "Solo performance only (Max: 3 mins).",
            "Offensive lyrics strictly prohibited.",
    ...
    },
    {
        ...
        image: { url: "/stock-videos/videography.mp4", type: "video" },
        rules: [
            "Team size: 1–4 participants.",
            "Film duration: 5–7 minutes.",
            "Must be original & copyright-free.",
            "Bring Drive link & copy in pendrive.",
        ],
    ...
    },
    {
        ...
        image: { url: "/stock-videos/Rampwalk.mp4", type: "video" },
        rules: [
            "Team size: 5 members (Time: 3-5 mins).",
